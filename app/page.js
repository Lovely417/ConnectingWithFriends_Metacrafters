...
export default function HomePage() {
  ...
  const socialContractInstance = "0x888a07E2e749C882d9d5852518A493F87F8c8D46";
  ...
  const initUser = () => {
    ...
    return (
      <div className="text-2xl m-8 text-black">
        <p className="">
          Your Address :{" "}
  ...
  return (
    <div className="bg-white">
      ...
      <div className=" bg-white text-white grid grid-cols-2 m-10">
        <form className="grid bg-[#664343] px-20 py-10  col-start-1 col-end-3 mx-64 rounded-xl">
      ...
      <div className="flex  justify-center">
        <button
          className="text-2xl text-black flex justify-center font-extralight py-4 rounded-xl "
          onClick={getFriends}
        >
          Show Friends
        </button>
      ...
      {friendList && (
        <>
          <div className="text-black mx-auto max-w-7xl pt-40 px-6" id="exchange-section">
            <div className="table-b  text-black bg-navyblue p-8 overflow-x-auto">
              <h3 className="text-black text-offwhite text-2xl justify-center flex">
                Friend List
              </h3>
              <table className="table-auto text-black w-full mt-10">
                <thead>
                  <tr className=" bg-darkblue rounded-lg text-black">
                ...
                <tbody>
                  {friendList.map((eachFriend, i) => (
                    <tr key={i} className="border-b border-b-darkblue text-black">
